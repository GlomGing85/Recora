...
| Записи | 🗑 Видалення (довгий тап) | Порожній стан |
|:---:|:---:|:---:|
| <img src="docs/screenshots/recordings.jpg" width="200" alt="Recora — список записів"> | <img src="docs/screenshots/delete.jpg" width="200" alt="Recora — видалення запису"> | <img src="docs/screenshots/empty.jpg" width="200" alt="Recora — порожній список"> |
...
## ⬇️ Встановлення та оновлення

- **Releases** / **Actions artifacts** — обидва підписані **одним стабільним
  debug-ключем** (`debug.keystore` у репо), тому з v0.2.1 нові версії ставляться
  **поверх**, без видалення старої.
- ⚠️ Виняток разовий: якщо встановлена v0.1.0/v0.2.0 зі старих артефактів
  (інший підпис) — видаліть її один раз, далі усе оновлюватиметься штатно.
...
| v0.2.1 | ✅ 🔐 Стабільний підпис CI (оновлення без перевстановлення), ⬆️ material 1.14.0 |
| v0.2.2 | 📜 CHANGELOG прямо в застосунку (з GitHub) |
| v0.2.3 | 🔄 «Перевірити оновлення» через GitHub Releases |
| v0.2.4 | 🌸 Екран «Про застосунок» / кредити |
| v0.2.5 | ❓ ідеї вітаються! |
